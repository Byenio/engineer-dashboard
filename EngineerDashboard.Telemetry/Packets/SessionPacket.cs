...
public struct SessionPacket
{
    ...
    /// <para>See <see cref="Weather"/> for weather conditions.</para>
    /// </summary>
    ...
    /// <para>See <see cref="Track"/> for track IDs.</para>
    /// </summary>
    public Track trackId;
    /// <summary>
    /// <para>Type of the cars in the session.</para>
    /// <para>See <see cref="Formula"/> for the types of cars.</para>
    /// </summary>
    ...
    /// <para>See <see cref="SafetyCarStatus"/> for the status values.</para>
    /// </summary>
    ...
    /// <para>See <see cref="GameMode"/> for available game modes.</para>
    /// </summary>
    public GameMode gameMode;
    /// <summary>
    /// <para>Current rule set.</para>
    /// <para>See <see cref="RuleSet"/> for available rule sets.</para>
    /// </summary>
